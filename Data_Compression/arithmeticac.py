...
def encode(x, b, num = 0, scale=(100000,1)): #Text = x, Frequency Table Bias = b
...
def decode(y,b,n,num=0, scale=(100000,1)): #Coded Text = y, bias = b, number of characters in original text = n
    precision = 32
    one = int(2**precision - 1)
    quarter = int(ceil(one/4))
    half = 2*quarter
